...
#include "LTT/lttosal.h"
#include "LTT/ltt2api.h"
#include "LTT/ltt2api_emulation.h"
...
int main( void )
{
    ...
    LTTSetDeviceEmulation( 0x00021821 );
    ...
    */
    ...
    p_data = (unsigned char *)malloc( chunk_seq_cnt * sequence_len * sample_size );
    if( !p_data ) {
